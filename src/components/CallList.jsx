      ...
      <div className="overflow-y-auto max-h-[calc(100vh-300px)]">
        {calls.map((call) => (
          <div
            ...
            className={`p-6 border-b border-[#2B7FFF33] cursor-pointer transition-colors ${
              selectedId === call.id
                ? "bg-[#2B7FFF10] border-l-4 border-l-[#2B7FFF]"
                : "hover:bg-[#FFFFFF05]"
            }`}
          >
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#2B7FFF20] rounded-lg">
                  <Icon icon="mdi:phone" width={20} className="text-[#2B7FFF]" />
                </div>
                <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <span className="text-[10px] bg-[#2B7FFF20] text-[#2B7FFF] px-2 py-0.5 rounded uppercase font-bold">
                {call.issueType}
              </span>
            </div>
          </div>
